 ...
 * Generated: 2026-04-03T00:33:53.557Z (Modified for TR support)
 */
...
function getIMDBId(tmdbId, mediaType) {
  return __async(this, null, function* () {
    var _a;
    // &language=tr-TR parametresi eklendi
    const url = `${TMDB_BASE_URL}/${mediaType}/${tmdbId}?api_key=${TMDB_API_KEY}&language=tr-TR&append_to_response=external_ids`;
